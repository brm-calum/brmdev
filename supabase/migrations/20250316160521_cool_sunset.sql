/*
  # Add Get Offer Function

  1. New Functions
    - `get_offer_with_relationships`: Gets complete offer details with all relationships
  ...
  3. Changes
    - Creates a new function to handle offer retrieval
    - Includes all related data in a single query
*/
