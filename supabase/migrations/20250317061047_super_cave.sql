/*
  # Fix Price Column in Offer Space Allocations

  1. Changes
    - Add price_per_m2_cents column to offer_space_allocations
    - Update get_offer_with_relationships function to use correct column names
...
-- Add price_per_m2_cents column if it doesn't exist
ALTER TABLE public.offer_space_allocations 
ADD COLUMN IF NOT EXISTS price_per_m2_cents bigint;
