/*
  # Fix Space ID Foreign Key Constraint

  1. Changes
    - Add proper foreign key constraint for space_id
    - Add validation to ensure space exists before saving
...
-- Update save_booking_offer function to validate space_id
...
-- Add comment
COMMENT ON FUNCTION public.save_booking_offer IS 'Creates a new booking offer with proper validation of space and service IDs';