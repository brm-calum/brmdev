/*
  # Fix Space Allocations Schema

  1. Changes
    - Add missing space_allocated_m2 column to offer_space_allocations
    - Add missing quantity column to offer_service_allocations
...
-- Fix offer_space_allocations table
ALTER TABLE public.offer_space_allocations
ADD COLUMN IF NOT EXISTS space_allocated_m2 numeric;

-- Fix offer_service_allocations table
ALTER TABLE public.offer_service_allocations
...
-- Add comments
COMMENT ON COLUMN public.offer_space_allocations.space_allocated_m2 IS 'The amount of space allocated for this offer in square meters';
COMMENT ON COLUMN public.offer_service_allocations.quantity IS 'The quantity of the service being offered';